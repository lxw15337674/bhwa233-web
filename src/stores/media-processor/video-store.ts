...
import { VideoProcessorState, ProcessorStoreActions } from './types';
...
const initialState: VideoProcessorState = {
  // 文件相关
  selectedFile: null,
  mediaMetadata: null,
  audioInfo: null,
  ...
  // 视频功能
  currentFunction: getDefaultFunction('video'),
};

export const useVideoProcessorStore = create<VideoProcessorState & ProcessorStoreActions>()(
  devtools(
    immer((set) => ({
      ...initialState,
