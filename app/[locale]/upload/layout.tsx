...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const metadataMap = {
    en: {
      ...
      description: 'Free online file upload service, supports any file format, up to 10MB file size, permanent storage. Batch upload up to 10 files.',
    ...
    zh: {
      ...
      description: '免费在线文件上传服务，支持任意文件格式、最大10MB文件上传，永久保存。批量上传最多10个文件。',
    ...
    'zh-tw': {
      ...
      description: '免費線上檔案上傳服務，支援任意檔案格式、最大10MB檔案上傳，永久保存。批次上傳最多10個檔案。',
